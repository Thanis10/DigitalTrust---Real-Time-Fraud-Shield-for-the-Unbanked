  ...
  return (
    <div className="mb-12">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-sm font-bold text-white tracking-wide">Your Cards</h3>
      </div>
      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-[#13072e] to-[#0c021a] rounded-3xl p-6 overflow-hidden shadow-2xl z-10 h-48 flex flex-col justify-between border border-white/5">
          ...
          <div className="flex justify-between items-start relative z-10">
            <div>
              <div className="text-2xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-300 tracking-tighter drop-shadow-md">VISA</div>
